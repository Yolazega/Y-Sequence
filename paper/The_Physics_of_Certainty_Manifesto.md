...
The measurement distribution from the IBM Quantum job demonstrated a statistically significant lock into the expected entangled states |00> and |11>.

| Metric | Result | Standard Deviation |
| :--- | :--- | :--- |
| **Fidelity** | **99.2%** | +/- 0.05% |
| **SNR** | **16.07 dB** | - |
| **Error Rate** | **0.8%** | (Bit-flip errors in |01> / |10>) |
